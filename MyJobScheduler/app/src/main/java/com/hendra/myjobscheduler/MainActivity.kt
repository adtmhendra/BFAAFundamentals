...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun startJob() {
        ...
        if (isJobRunning(this)) {
            showToast(this, "Job Service already scheduled")
            return
        }
        ...
        */
        ...
        showToast(this, "Job Service started")
    ...
    private fun cancelJob() {
        ...
        showToast(this, "Job Service canceled")

    }

    // mengecek apakah job sudah berjalan atau belum
    ...
    override fun onClick(v: View) {
        ...
        when(v.id) {
            ...
            R.id.btnStart -> startJob()

            R.id.btnCancel -> cancelJob()
